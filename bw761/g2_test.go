...
// ------------------------------------------------------------
// utils
func fuzzJacobianG2(p *G2Jac, f fp.Element) G2Jac {
	var res G2Jac
...
func fuzzProjectiveG2(p *G2Proj, f fp.Element) G2Proj {
	var res G2Proj
	res.X.Mul(&p.X, &f)
	res.Y.Mul(&p.Y, &f)
	res.Z.Mul(&p.Z, &f)
...
func fuzzExtendedJacobianG2(p *g2JacExtended, f fp.Element) g2JacExtended {
